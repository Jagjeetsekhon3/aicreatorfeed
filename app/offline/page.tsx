...
export default function OfflinePage() {
  return (
    <div style={{ minHeight: '80vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px', textAlign: 'center' }}>
      ...
      <h1 style={{ fontSize: '24px', fontWeight: 900, color: 'var(--color-cream)', marginBottom: '10px' }}>You are offline</h1>
      ...
      <button
        ...
        style={{ background: 'var(--color-primary)', border: 'none', color: '#fff', fontWeight: 700, padding: '12px 28px', borderRadius: '12px', fontSize: '14px', cursor: 'pointer', fontFamily: 'inherit' }}
      >
        Try again
      </button>
    </div>
